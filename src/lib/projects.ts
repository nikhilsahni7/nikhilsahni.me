export const webProjects = [
...

  {
    title: "RawPng",
    description:
      "A full-stack e-commerce platform for users to to get free png,vector images  and other resources to use in their projects and download for free",
    liveLink: "https://rawpng.com",
    githubLink: "https://github.com/nikhilsahni7/RawPng",
    tags: [
      "Next.js",
      "MongoDB",
      "TypeScript",
...
export const appProjects = [
  ...
  },
  {
    title: "TaxiSure App",
    description:
      "A cross-platform mobile application for booking taxis with real-time tracking and payment gateway and driver details and user profile and admin panel",
    playStoreLink: "https://github.com/nikhilsahni7/TaxiSure-App",
    appStoreLink: "https://github.com/nikhilsahni7/TaxiSure-App",
    githubLink: "code is private",
    tags: [
      "Flutter",
      "Firebase",
